...
import { GetCategoriesAlongChildrenArgs } from './dto/get-categories-along-children.args';
...
export class CategoriesResolver {
  ...
  @Query(() => [Category], { name: 'categoriesAlongChildren' })
  async getCategoriesAlongChildren(
    @Args() getCategoriesAlongChildrenArgs: GetCategoriesAlongChildrenArgs,
  ): Promise<Category[]> {
